...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            ...
            "/home/shabgard/Desktop/DigitalTwin/Trans-DomainDigitalTwinOfCattleFarming/code/tddt_livestock_20260520_1857/climate_simulator/include/python_bridge.hpp",
        ...
        "include_dirs": [
            "/home/shabgard/Desktop/DigitalTwin/Trans-DomainDigitalTwinOfCattleFarming/code/tddt_livestock_20260520_1857/climate_simulator",
            "/home/shabgard/Desktop/DigitalTwin/Trans-DomainDigitalTwinOfCattleFarming/code/tddt_livestock_20260520_1857/climate_simulator/include"
        ],
        "language": "c++",
        "name": "climate_hall_simulator._core",
        "sources": [
            "climate_hall_simulator/_core.pyx",
            "src/animal_load.cpp",
            "src/config.cpp",
            "src/csv.cpp",
    ...
    "module_name": "climate_hall_simulator._core"
}
END: Cython Metadata */
...
#define __PYX_HAVE__climate_hall_simulator___core
#define __PYX_HAVE_API__climate_hall_simulator___core
/* Early includes */
#include <string.h>
#include <string_view>
#include "ios"
...
#include "include/herd_inventory.hpp"
#include "include/ifc_reader.hpp"
#include "include/config.hpp"
#include "include/csv.hpp"
#include "include/report.hpp"
#include "include/thermoregulation_config.hpp"
...
/* Module declarations from "climate_hall_simulator._core" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "climate_hall_simulator._core"
extern int __pyx_module_is_main_climate_hall_simulator___core;
int __pyx_module_is_main_climate_hall_simulator___core = 0;

/* Implementation of "climate_hall_simulator._core" */
...
__Pyx_RefNannySetupContext("PyInit__core", 0);
  ...
  if (__pyx_module_is_main_climate_hall_simulator___core) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "climate_hall_simulator._core")) {
      if (unlikely((PyDict_SetItemString(modules, "climate_hall_simulator._core", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
  ...
  /* "climate_hall_simulator/_core.pyx":1
 * # See _core.pyx.template for C++ declarations. This module is intended to be built with Cython.             # <<<<<<<<<<<<<<
 * # The companion setup.py compiles the real binding and exposes pandas DataFrame outputs.
 * # Direct API documented in README.md and TUTORIAL.md.
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init climate_hall_simulator._core", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init climate_hall_simulator._core");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
